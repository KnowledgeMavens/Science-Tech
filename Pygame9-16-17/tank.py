...
code for video series 45-84 (5-10 minutes each, 5 hours)
...
def game_controls():
    ...
    while gcont:
        ...
        message_to_screen("Change Power:A or D",black,90)
...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("The more eneimies you destroy, the harder they get.",black,50)
